...
def generate_paathsala_dpp(subject, topic, target_class):
    ...
    3. For integration, use the standard Unicode symbol '∫'.
    4. For powers/exponents, use Unicode superscripts like '²', '³'.
    5. For Greek letters, use standard Unicode symbols like 'θ', 'π', 'α', 'β'.
    6. For fractions, use standard slash 'a/b' format.
